...
def calculate_demographic_data(print_data=True):
    ...
    average_age_men = round(df.loc[df['sex'] == 'Male']['age'].sum() / len(df.loc[df['sex'] == 'Male']), 1)
    ...
    top_IN_occupation = df.loc[(df['native-country'] == 'India')].loc[(df['salary'] == '>50K')]['occupation'].value_counts().sort_values(ascending=False).index[0]
